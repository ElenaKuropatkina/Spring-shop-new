package com.elenakuropatkina.steps;

import com.elenakuropatkina.DriverInitializer;
...
public class LoginSteps {
    ...
    @Then("^name should be \"([^\"]*)\"$")
    public void nameShouldBe(String login) throws Throwable {
        WebElement webElement = webDriver.findElement(By.id("dd_user"));
        assertThat(webElement.getText()).isEqualTo(login);
    }
